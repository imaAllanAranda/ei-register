...
<x-jet-responsive-nav-link href="{{ route('merits.index') }}" icon="heroicon-o-user"
:active="false">
Attendance
</x-jet-responsive-nav-link>
@endif
...
<x-jet-responsive-nav-link href="{{ route('merits.index') }}" icon="heroicon-o-star"
:active="false">
Merits
</x-jet-responsive-nav-link>
@endif
...
:active="request()->routeIs('policy.index')" icon="heroicon-o-clipboard-list">
